...
import '../features/user/auth_api/user_api_repository.dart';
import '../features/user/auth_api/user_http_api_repository.dart';
...
class ServiceLocator {
  void servicesLocator() {
    ...
    ); // Registering UserHttpApiRepository as a lazy singleton for UserApiRepository
  }
}
